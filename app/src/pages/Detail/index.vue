        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              >
                <dt class="title">选择{{ spuSale.saleAttrName }}</dt>
                <dd
                  changepirce="0"
...
export default {
  ...
  methods: {
    //点击激活active   isChecked为1代表激活
    //valueList代表颜色，内存等某一售卖属性，value代表用户点击的具体属性如黄色，蓝色；64G,16G
    changeActive(value, valueList) {
      // console.log(value);
      //先把valueList所有value的isChecked置0
